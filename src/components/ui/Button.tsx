...
export function Button ({ children, uiRef, id, title, label, color, size, fill, shape, width, selected, disabled, focusable = true, class: className = '', onClick, style }: ButtonProps) {
